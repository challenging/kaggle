...
def worker(working_queue, folder_submission):
    while True:
        ...
        best_hotels_search_dest, best_hotels_search_dest1, best_hotels_od_ulc, best_hotels_country, best_hotels_weekday, popular_hotel_cluster = prepare_arrays_match(filepath_training)
        with open(filepath_submission, "wb") as OUTPUT:
            for user_id, filled in gen_submission(filepath_testing, best_hotels_search_dest, best_hotels_search_dest1, best_hotels_od_ulc, best_hotels_country, best_hotels_weekday, popular_hotel_cluster):
